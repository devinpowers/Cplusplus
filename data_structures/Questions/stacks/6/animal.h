...
class Shelter
{
    public:
        ...
        {
            return std::static_pointer_cast<Animal>(cats.dequeue());
        }

        std::shared_ptr<Animal> dequeueDog()
        {
            return std::static_pointer_cast<Animal>(dogs.dequeue());
        }
